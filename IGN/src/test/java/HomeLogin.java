...
//        for (x = 1; x < 10; x++) {
//
//            waitUntilVisible(By.id("loadMore"));
//            scrollToElementById("loadMore");
//            waitUntilVisible(By.id("loadMore"));
//            clickById("loadMore");
//            sleepFor(3);
...
//    @Test(priority = 51)
//
//    public void VideoScrollIGNAccess() throws InterruptedException {
//
//        mouseHoverByXpath("html/body/header/div/nav/div[2]/li[1]/a");
//        sleepFor(1);
//        clickByLink("IGN Access");
//        sleepFor(4);
//        clickByXpath("html/body/section[2]/section[1]/div[2]/div/div[1]/div[3]");
//        sleepFor(5);
//        scrollToElementByXpath("html/body/section[2]/section[1]/div[2]/div/div[2]/div[2]/div/ul/li[8]/a");
//        sleepFor(5);
//        clickByXpath("html/body/section[2]/section[1]/div[2]/div/div[2]/div[2]/div/ul/li[8]/a");
//        sleepFor(3);
//    }
//
//    @Test(priority = 52)
//
//    public void VideoScrollDailyFix() throws InterruptedException {
//
//        mouseHoverByXpath("html/body/header/div/nav/div[2]/li[1]/a");
//        sleepFor(2);
//        clickByLink("Daily Fix");
//        sleepFor(5);
//        clickByClass("muted-autoplay");
//        sleepFor(3);
//
//    }
    ...
    public void tryLog() throws InterruptedException {
